...
/**
 * Lathekin Class extends CheckAndPick implements ModelSideToolCard
 * This class represents the ToolCard Lathekin
 * @author Luca Massini
 * @author Davide Lorenzi (JDocs)
 */
public class Lathekin extends CheckAndPick implements ModelSideToolCard {
    private static final int CARDNUMBER = 4;
   private static final int NUMBEROFTIMES=2;
     /*
    ...
    public boolean arePlacementConstraintsRespected(int newRow, int newColumn, Die chosenDie, Player player) {
        ...
        ChooseCheckConstraint checker = new ChooseCheckConstraint(new CheckDiePlacement());
